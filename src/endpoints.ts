...
export const asset = (id: number) => `http://www.roblox.com/asset/?Id=${id}`
export const userList = (userId: number, startRow = 0) => `${LIST}&userId=${userId}&startRow=${startRow}`
export const groupList = (groupId: number, startRow = 0) => `${LIST}&groupId=${groupId}&startRow=${startRow}`
